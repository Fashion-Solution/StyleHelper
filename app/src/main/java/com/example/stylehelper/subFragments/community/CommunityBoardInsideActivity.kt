...
import com.example.stylehelper.databinding.ActivityCommunityBoardInsideBinding
import com.example.stylehelper.utils.FBRef
import com.google.firebase.auth.ktx.auth
import com.google.firebase.database.*
import com.google.firebase.ktx.Firebase
import com.google.firebase.storage.ktx.storage
import kotlinx.android.synthetic.main.activity_community_board_inside.*
...
class CommunityBoardInsideActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_community_board_inside)
        ...
        binding.likebtn.setOnClickListener {
            onStarClicked(FBRef.communityboardRef.child(key))
        }
        ...
        user?.let {
            ...
            val postListener = object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    val dataModel = dataSnapshot.getValue(CommunityBoardModel::class.java)
            ...
            //FBRef에서 데이터를 가져온다.
            FBRef.communityboardRef.child(key).addValueEventListener(postListener)
        }
    }
        ...
        user?.let {
            ...
            postRef.runTransaction(object : Transaction.Handler {
                override fun doTransaction(mutableData: MutableData): Transaction.Result {
                    val dataModel = mutableData.getValue(CommunityBoardModel::class.java)

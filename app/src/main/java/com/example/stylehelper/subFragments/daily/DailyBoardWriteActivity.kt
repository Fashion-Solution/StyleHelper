...
import com.example.stylehelper.databinding.ActivityDailyBoardWriteBinding
...
class DailyBoardWriteActivity : AppCompatActivity() {
    private lateinit var binding: ActivityDailyBoardWriteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_daily_board_write)
        ...
        binding.writeUploadBtn.setOnClickListener {
            ...
            //이미지 이름을 위해 키값부터 생성
            val key = FBRef.dailyboardRef.push().key.toString()
            ...
            FBRef.dailyboardRef
                .child(key)
                .setValue(DailyBoardModel(title, content, uid, time, style, likecount, likes))

            Toast.makeText(this, "데일리룩 입력 완료", Toast.LENGTH_LONG).show()
